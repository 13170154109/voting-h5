...
(function($)
{
	...
	Redactor.fn = $.Redactor.prototype = {
		...
		cleanConvertInlineTags: function(html, set)
		{
			...
			html = html.replace(/<span style="">([\w\W]*?)<\/span>/gi, '<' + boldTag + '>$1</' + boldTag + '>');
		...
		pasteClean: function(html)
		{
			...
			html = html.replace(/<b(.*?)id="docs-internal-guid(.*?)">([\w\W]*?)<\/b>/gi, "$3");
	 		...
	 		html = html.replace(/<span[^>]*(font-style: italic; font-weight: bold| font-style: italic)[^>]*>/gi, '<span style=""><span style="font-style: italic;">');
	 		html = html.replace(/<span[^>]*font-style: italic[^>]*>/gi, '<span style="font-style: italic;">');
			html = html.replace(/<span[^>]*font-weight: bold[^>]*>/gi, '<span style="">');
