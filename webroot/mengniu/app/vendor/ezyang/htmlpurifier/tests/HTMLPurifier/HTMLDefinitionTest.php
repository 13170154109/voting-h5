...
'),
    ...
    public function assertPurification_AllowedAttributes_global_style()
    {
        $this->assertPurification(
            '<p style="" class="foo">Jelly</p><br style="clear:both;" />',
            '<p style=";">Jelly</p><br style="clear:both;" />');
    }
    ...
    public function test_AllowedAttributes_multiple()
    {
        ...
        $this->assertPurification(
            '<p style="" class="foo" title="foo">Jelly</p><br style="clear:both;" class="foo" title="foo" />',
            '<p style="" title="foo">Jelly</p><br class="foo" title="foo" />'
        );
    }
